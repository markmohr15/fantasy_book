class FantasyController < ApplicationController
  ...
  def my_history
    if params[:beg_date].present?
      ...
      start_date = start_params[6..9] + start_params[5] + start_params[0..2] + start_params[3..4]
      ending_date = ending_params[6..9] + ending_params[5] + ending_params[0..2] + ending_params[3..4]
