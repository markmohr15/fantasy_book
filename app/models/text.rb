...
class Text < ActiveRecord::Base
  ...
  def self.deposit_made deposit
    text = deposit.user.username + ", your " + deposit.kind + " deposit in the amount of $" + sprintf('%.2f', deposit.amount_dollars).to_s + " was approved. \nThank you,\nFantasyBook.guru"
    client = Twilio::REST::Client.new Rails.application.secrets.twilio_account_sid, Rails.application.secrets.twilio_auth_token
